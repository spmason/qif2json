...
describe('normalTransactions', function(done) {
    var reader = fs.createReadStream(__dirname + '/files/normalTransactions.qif');

    it ('can parse normalTransactions', function(done) {
